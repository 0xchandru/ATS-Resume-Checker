  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 mt-5">
        {[
          { icon: Database, label: "Knowledge Sources", value: "ESCO + O*NET" },
          { icon: BarChart3, label: "Matching Layers",  value: "5-Layer AI" },
          { icon: Zap,       label: "Analysis Points",  value: "50+" },
        ].map(({ icon: Icon, label, value }) => (
          <div key={label} className="bg-card border border-border rounded-xl p-4 text-center hover:border-primary/30 transition-colors">
