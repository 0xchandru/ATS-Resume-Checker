...
from models import ScanRecord, ScanResult
from engine import parser, extractor, matcher, scorer, section_detector, format_checker, career_analyzer, feedback_engine
...
async def analyze_resume(scan_id: str, db: Session = Depends(get_db)):
    ...
    jd_kws = extractor.extract_jd_keywords(jd_text)
